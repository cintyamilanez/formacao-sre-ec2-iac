output "prometheus_node_exporter_aws_elastic_ip" {
  value       = "http://${aws_eip.wordpress_eip.public_ip}:${var.prometheus_node_exporter_port}"
...
output "wordpress_aws_elastic_telemetry_path" {
  value       = "http://${aws_eip.wordpress_eip.public_ip}:${var.wordpress_port}/${var.prometheus_node_exporter_telemetry_path}"
